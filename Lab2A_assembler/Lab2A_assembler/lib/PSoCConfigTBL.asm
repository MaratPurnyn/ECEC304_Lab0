...
export LoadConfigTBL_lab2a_assembler_Bank1
export LoadConfigTBL_lab2a_assembler_Bank0
export LoadConfigTBL_lab2a_assembler_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab2a_assembler_Bank0:
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_lab2a_assembler_Bank1:
...
LoadConfigTBL_lab2a_assembler_Ordered:
