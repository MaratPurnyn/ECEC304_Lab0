...
export LoadConfig_lab2a_assembler
export _LoadConfig_lab2a_assembler
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab2a_assembler
	lcall	LoadConfigTBL_lab2a_assembler_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab2a_assembler
;
;    Load configuration registers for lab2a_assembler.
...
;               CUR_PP
;
_LoadConfig_lab2a_assembler:
 LoadConfig_lab2a_assembler:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab2a_assembler_Bank0
    mov     X, <LoadConfigTBL_lab2a_assembler_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab2a_assembler_Bank1
    mov     X, <LoadConfigTBL_lab2a_assembler_Bank1
