...
;  Instance name DBB00, User Module PWM8
;       Instance name DBB00, Block Name PWM8(DBB00)
	db		23h, 00h		;DBB00_CONTROL_REG(DBB00CR0)
	db		21h, ffh		;DBB00_PERIOD_REG(DBB00DR1)
	db		22h, ffh		;DBB00_COMPARE_REG(DBB00DR2)
...
;  Instance name DBB00, User Module PWM8
;       Instance name DBB00, Block Name PWM8(DBB00)
	db		20h, 31h		;DBB00_FUNC_REG(DBB00FN)
	db		21h, 11h		;DBB00_INPUT_REG(DBB00IN)
	db		22h, 34h		;DBB00_OUTPUT_REG(DBB00OU)
;  Instance name LCD, User Module LCD
;  Instance name TachOverridePWM, User Module PWM16
;       Instance name TachOverridePWM, Block Name PWM16_LSB(DBB01)
	db		24h, 01h		;TachOverridePWM_FUNC_LSB_REG(DBB01FN)
	db		25h, 1ah		;TachOverridePWM_INPUT_LSB_REG(DBB01IN)
	db		26h, 00h		;TachOverridePWM_OUTPUT_LSB_REG(DBB01OU)
;       Instance name TachOverridePWM, Block Name PWM16_MSB(DCB02)
	db		28h, 21h		;TachOverridePWM_FUNC_MSB_REG(DCB02FN)
	db		29h, 3ah		;TachOverridePWM_INPUT_MSB_REG(DCB02IN)
	db		2ah, 05h		;TachOverridePWM_OUTPUT_MSB_REG(DCB02OU)
