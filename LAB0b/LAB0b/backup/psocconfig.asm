...
export LoadConfig_lab0b
export _LoadConfig_lab0b
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab0b
	lcall	LoadConfigTBL_lab0b_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab0b
;
;    Load configuration registers for lab0b.
...
_LoadConfig_lab0b:
 LoadConfig_lab0b:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab0b_Bank0
    mov     X, <LoadConfigTBL_lab0b_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab0b_Bank1
    mov     X, <LoadConfigTBL_lab0b_Bank1
