...
export LoadConfigTBL_lab0b_Bank1
export LoadConfigTBL_lab0b_Bank0
export LoadConfigTBL_lab0b_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab0b_Bank0:
...
;       Instance name LEDFlashTimer, Block Name TIMER8(DBB01)
	...
	db		25h, ffh		;LEDFlashTimer_PERIOD_REG(DBB01DR1)
