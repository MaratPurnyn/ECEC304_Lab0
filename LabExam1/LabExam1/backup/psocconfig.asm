...
export LoadConfig_labexam1
export _LoadConfig_labexam1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_labexam1
	lcall	LoadConfigTBL_labexam1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration labexam1
;
;    Load configuration registers for labexam1.
...
_LoadConfig_labexam1:
 LoadConfig_labexam1:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_labexam1_Bank0
    mov     X, <LoadConfigTBL_labexam1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_labexam1_Bank1
    mov     X, <LoadConfigTBL_labexam1_Bank1
