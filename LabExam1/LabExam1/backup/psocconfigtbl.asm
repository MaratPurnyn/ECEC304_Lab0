...
export LoadConfigTBL_labexam1_Bank1
export LoadConfigTBL_labexam1_Bank0
export LoadConfigTBL_labexam1_Ordered
AREA lit(rom, rel)
LoadConfigTBL_labexam1_Bank0:
...
LoadConfigTBL_labexam1_Ordered:
