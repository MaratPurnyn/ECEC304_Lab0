...
export LoadConfig_lab5b
export _LoadConfig_lab5b
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab5b
	lcall	LoadConfigTBL_lab5b_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab5b
;
;    Load configuration registers for lab5b.
...
_LoadConfig_lab5b:
 LoadConfig_lab5b:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab5b_Bank0
    mov     X, <LoadConfigTBL_lab5b_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab5b_Bank1
    mov     X, <LoadConfigTBL_lab5b_Bank1
