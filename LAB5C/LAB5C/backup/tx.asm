...
;  Global Symbols
;-----------------------------------------------
export   TX_SetTxIntMode
export  _TX_SetTxIntMode
export   TX_EnableInt
export  _TX_EnableInt
export   TX_DisableInt
export  _TX_DisableInt
export   TX_Start
export  _TX_Start
export   TX_Stop
export  _TX_Stop
export   TX_SendData
export  _TX_SendData
export   TX_bReadTxStatus
export  _TX_bReadTxStatus

// Old labels, will be removed in future release
// Do Not Use.
export   bTX_ReadTxStatus
export  _bTX_ReadTxStatus

;-----------------------------------------------
;  High Level TX functions
;-----------------------------------------------
export  TX_PutSHexByte
export _TX_PutSHexByte
export  TX_PutSHexInt
export _TX_PutSHexInt

export  TX_CPutString
export _TX_CPutString
export  TX_PutString
export _TX_PutString
export  TX_PutChar
export _TX_PutChar
export  TX_Write
export _TX_Write
...
_TX_EnableInt:
   ...
   M8C_EnableIntMask  TX_INT_REG, TX_bINT_MASK
...
_TX_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask TX_INT_REG, TX_bINT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_SetTxIntMode(BYTE bTxIntMode)
;
;  DESCRIPTION:
...
_TX_SetTxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   A, TX_INT_MODE_TX_COMPLETE
   jz    .SetModeRegEmpty
   or    REG[TX_FUNC_REG], bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.SetModeRegEmpty:
   and   REG[TX_FUNC_REG], ~bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_TX_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[TX_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: TX_bReadTxStatus
;
;  DESCRIPTION:
...
_TX_PutSHexByte:
    ...
    index TX_HEX_STR                   ; Get Hex value
    call  TX_PutChar                   ; Write data to screen
    pop   A                            ; Restore value
...
_TX_PutSHexInt:
    RAM_PROLOGUE RAM_USE_CLASS_1
    swap  A,X
    call  TX_PutSHexByte               ; Print MSB
    mov   A,X                          ; Move LSB into position
    call  TX_PutSHexByte               ; Print LSB
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
...
.BufEmptyWaitLoop:
   tst REG[TX_CONTROL_REG], TX_TX_BUFFER_EMPTY    ; Check Tx Status
   jz  .BufEmptyWaitLoop
   mov REG[TX_TX_BUFFER_REG], @Source    ; Write data to Tx Port
   endm
...
.PutStringLoop:
   ...
   call  TX_PutChar                         ; Send character to Tx port
...
_TX_CPutString:
   ...
   romx                                          ; Get character from ROM
   jz    .End_CPutString
   call  TX_PutChar                         ; Print character
   pop   X
   pop   A
   inc   X                                       ; Inc LSB of pointer
   jnc   TX_CPutString                           ; Check for carry
