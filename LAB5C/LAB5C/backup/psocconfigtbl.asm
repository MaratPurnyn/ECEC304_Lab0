...
export LoadConfigTBL_lab5b_Bank1
export LoadConfigTBL_lab5b_Bank0
export LoadConfigTBL_lab5b_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab5b_Bank0:
...
;       Instance name BaudClock, Block Name PWM8(DBB00)
	...
	db		21h, 34h		;BaudClock_PERIOD_REG(DBB00DR1)
	db		22h, 1ah		;BaudClock_COMPARE_REG(DBB00DR2)
;  Instance name LCD, User Module LCD
;  Instance name TX, User Module TX8
;       Instance name TX, Block Name TX8(DCB02)
	db		2bh, 00h		;TX_CONTROL_REG  (DCB02CR0)
	db		29h, 00h		;TX_TX_BUFFER_REG(DCB02DR1)
	db		2ah, 00h		;TX_(DCB02DR2)
;  Global Register values Bank 0
	...
	db		b5h, 18h		; Row_0_OutputDrive_0 register (RDI0SRO0)
	...
	db		ffh
LoadConfigTBL_lab5b_Bank1:
;  Instance name BaudClock, User Module PWM8
;       Instance name BaudClock, Block Name PWM8(DBB00)
	db		20h, 71h		;BaudClock_FUNC_REG(DBB00FN)
	db		21h, 14h		;BaudClock_INPUT_REG(DBB00IN)
	db		22h, 05h		;BaudClock_OUTPUT_REG(DBB00OU)
;  Instance name LCD, User Module LCD
;  Instance name TX, User Module TX8
;       Instance name TX, Block Name TX8(DCB02)
	db		28h, 0dh		;TX_FUNC_REG     (DCB02FN)
	db		29h, 02h		;TX_INPUT_REG    (DCB02IN)
	db		2ah, 47h		;TX_OUTPUT_REG   (DCB02OU)
