...
export LoadConfig_lab1c_c_code
export _LoadConfig_lab1c_c_code
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lab1c_c_code
	lcall	LoadConfigTBL_lab1c_c_code_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lab1c_c_code
;
;    Load configuration registers for lab1c_c_code.
...
;               CUR_PP
;
_LoadConfig_lab1c_c_code:
 LoadConfig_lab1c_c_code:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lab1c_c_code_Bank0
    mov     X, <LoadConfigTBL_lab1c_c_code_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lab1c_c_code_Bank1
    mov     X, <LoadConfigTBL_lab1c_c_code_Bank1
