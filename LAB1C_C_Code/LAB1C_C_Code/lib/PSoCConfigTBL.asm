...
export LoadConfigTBL_lab1c_c_code_Bank1
export LoadConfigTBL_lab1c_c_code_Bank0
export LoadConfigTBL_lab1c_c_code_Ordered
AREA lit(rom, rel)
LoadConfigTBL_lab1c_c_code_Bank0:
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_lab1c_c_code_Bank1:
...
LoadConfigTBL_lab1c_c_code_Ordered:
